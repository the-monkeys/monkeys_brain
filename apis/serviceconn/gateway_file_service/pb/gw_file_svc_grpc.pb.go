...
const (
	...
	UploadBlogFile_ResolveAssetRead_FullMethodName = "/auth_svc.UploadBlogFile/ResolveAssetRead"
)
...
type UploadBlogFileClient interface {
	...
	ResolveAssetRead(ctx context.Context, in *ResolveAssetReadReq, opts ...grpc.CallOption) (*ResolveAssetReadResp, error)
}
...
func (c *uploadBlogFileClient) ResolveAssetRead(ctx context.Context, in *ResolveAssetReadReq, opts ...grpc.CallOption) (*ResolveAssetReadResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveAssetReadResp)
	err := c.cc.Invoke(ctx, UploadBlogFile_ResolveAssetRead_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UploadBlogFileServer interface {
	...
	ResolveAssetRead(context.Context, *ResolveAssetReadReq) (*ResolveAssetReadResp, error)
...
func (UnimplementedUploadBlogFileServer) UploadProfilePic(grpc.ClientStreamingServer[UploadProfilePicReq, UploadProfilePicRes]) error {
	return status.Error(codes.Unimplemented, "method UploadProfilePic not implemented")
}
func (UnimplementedUploadBlogFileServer) GetProfilePic(*GetProfilePicReq, grpc.ServerStreamingServer[GetProfilePicRes]) error {
	return status.Error(codes.Unimplemented, "method GetProfilePic not implemented")
}
func (UnimplementedUploadBlogFileServer) DeleteProfilePic(context.Context, *DeleteProfilePicReq) (*DeleteProfilePicRes, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteProfilePic not implemented")
}
func (UnimplementedUploadBlogFileServer) UploadBlogFile(grpc.ClientStreamingServer[UploadBlogFileReq, UploadBlogFileRes]) error {
	return status.Error(codes.Unimplemented, "method UploadBlogFile not implemented")
}
func (UnimplementedUploadBlogFileServer) GetBlogFile(*GetBlogFileReq, grpc.ServerStreamingServer[GetBlogFileRes]) error {
	return status.Error(codes.Unimplemented, "method GetBlogFile not implemented")
}
...
func (UnimplementedUploadBlogFileServer) ResolveAssetRead(context.Context, *ResolveAssetReadReq) (*ResolveAssetReadResp, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveAssetRead not implemented")
}
...
func RegisterUploadBlogFileServer(s grpc.ServiceRegistrar, srv UploadBlogFileServer) {
	// If the following call panics, it indicates UnimplementedUploadBlogFileServer was
...
func _UploadBlogFile_ResolveAssetRead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveAssetReadReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UploadBlogFileServer).ResolveAssetRead(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UploadBlogFile_ResolveAssetRead_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UploadBlogFileServer).ResolveAssetRead(ctx, req.(*ResolveAssetReadReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UploadBlogFile_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveAssetRead",
			Handler:    _UploadBlogFile_ResolveAssetRead_Handler,
		},
	},
